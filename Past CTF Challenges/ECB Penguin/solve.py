...
DIR = "Past CTF Challenges/ECB Penguin/"
ENC = "encrypted.bin"
OUT = "ecb.bmp"
...
size = len(enc) * 8 // 24   # Smart guess for approximate size of image because it is rgb
#print(enc)
print(enc)
# for w in range(3390, 3391, 1):  # Answer is 3390
for w in range(3390, 3391, 1):  # Guessed 3000 (would need to bruteforce a lot lol)
    with open(f"Past CTF Challenges/ECB Penguin/output/{w}.bmp", "wb") as f:
