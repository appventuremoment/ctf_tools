...
#Change this section only
    parser.add_argument('--modulus', '-N', dest='mod', action='store', type=int, default=,
                        help='Modulus to factorize')
    parser.add_argument('--disc', '-D', dest='disc', action='store', type=int, default=427,
                        help='D, the discriminant to compute factorization for')
    parser.add_argument('--prime-bits', dest='prime_bits', action='store', type=int, default=4096,
                        help='Number of prime bits to generate')



    parser.add_argument('--timeout', dest='timeout', action="store", type=int, default=-1,
